        ...
        <div class="fixed-con-lg bg-pink content ">
            ...
            <box  gap="8px 12px">
               ...
               <div class="footer-say">
                    注:全新二级分销体系无同级平行制约,每个级别均可按分润百分比自动分发
                </div>   
            </box>
...
export default {
    ...
    data() {
        return {
            ...
            {'title':'SVIP会员','cont1':'体系：A-B-C(二级分销利润80%,15%,5%)','cont2':'分润：万分之15(还款)，万分之8（提现）','cont3':'交易量：循环累计制','right':'晋级考核','right2':'交易量累计5000万'},
            {'title':'VIP会员','cont1':'体系：无','cont2':'分润：无','cont3':'','right':'晋级考核','right2':'直推2人或充值'},
