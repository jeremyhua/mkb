    ...
    <div id="post-content">
		...
		<div class="main bg-f0">
            <div class="m15">
                ...
                <div class="c-333 ft-title">设置抢单金币</div>
                <div class="select—box">
                    <input type="text" class="ft-name fs-15" placeholder="0" v-model="gold">
                </div>
                ...
                <div class="select—box">
                    <input type="text" class="ft-name fs-15" placeholder="请输入您的联系电话" v-model.number="mobile">
                </div>
                ...
                <div class="c-333 ft-title">座机号码</div>
                <div class="select—box">
...
<script>
	...
	export default {
		...
		components:{
			iHeader,CellSwipe, Popup,Picker
		}
	}
</script>
