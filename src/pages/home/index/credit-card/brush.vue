<template>
	<div id="credit_circle" class="wrap bg-f0" >
        <x-header :left-options="{backText: ''}">手刷POS机</x-header>
		<div class="main-body fixed-content">

               <div class="main-content-next">
                <div class="content-nav"><i></i>热门推荐 </div>
    ...
    methods:{
         openGrab(url){
          ...
          handleScroll(ev){
            ...
            getVisa(){
                this.$axios.post("/api/visa/get_brush")
                .then((results) => {
                    if(results.code==200){
...
// .main-body{position: fixed;top: 0;bottom:0;width: 100%;overflow-y: auto;}
